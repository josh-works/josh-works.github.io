...
I like to read, and I often recommend books to others. I used to have a very different list of recommended books, but they come and go with time. This list is sorta 'older', circa 2021. [^books-change] A newer/different list is available [here]({{ site.baseurl  }}{% link _posts/2024-06-04-recommended-reading.md %})
