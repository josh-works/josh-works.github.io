...
To 'jaywalk' would be to cross into or across a street, outside of a 'signalized intersection', outside of an 'appropriate time'. If you're white-passing, and perceivably not of the lowest economic class, you're vanishingly unlikely to ever hear from a 'law enforcement officer' a breath about 'jaywalking enforcement'.

If you're a person of the global majority, or perceivably poor, you're vastly more likely to have an encounter with violence-dealing coercive thugs. 
...
The innovation of jaywalking was a huge step forward for american policing.

Here's how to view "laws" and "claims of authority":

> Laws are threats made by the dominant socioeconomic-ethnic group in a given nation. It's just the promise of violence that's enacted and the police are basically an occupying army.

Because American Police got their start as "deputizing the slave patrols", jaywalking gave another HUGE realm for social control. Now police could justify assaulting someone as 'enforcing jaywalking laws'. 
...
Here's how Wikipedia recounts the story:

[Jaywalking (wikipedia)](https://en.wikipedia.org/wiki/Jaywalking) 
...
'law and order' is the rallying cry of the oppressor class. Remember that quote:

> Laws are threats made by the dominant socioeconomic-ethnic group in a given nation. It's just the promise of violence that's enacted and the police are basically an occupying army.

Next, 'laws' have also been the guise under which some of the worst atrocities known to humans have been committed, so... it would behoove us all to flex the muscles of 'breaking laws', which is just a propagandist phrase anyway.

The solution to jaywalking as an idea is to exercise [anarchist calisthenics](https://harpers.org/archive/2012/12/anarchist-calisthenics/) and jaywalk, yourself, and enlist friends and others in your scheme as often as possible. From Scott's piece:
...
An ethical read of streets says they're available to everyone, and just because you're not currently in a car doesn't mean you need to give enormous emotional deference to the presence of a vehicle. 

Please do read [Anarchist Calisthenics](https://harpers.org/archive/2012/12/anarchist-calisthenics/) by James C Scott. It's a short article.
...
[^bollards]: A skid steer + well-shaped rocks, serving as [bollards]({{ site.baseurl  }}{% link _posts/2024-04-30-bollards.md %}), large enough for an adult to sit on, obtained for functionally free, could neck down every road that has more than one lane in a given direction into a one-lane-each-way road. For all junctions, a would convert from from lights/stop-signs to roundabouts, shaped by rocks and bollards, with a target max speed in a city of no more than 30mph and a target min speed of 4 mph. everything would be fixed. "but car drivers would be surprised" says every traffic engineer and police officer I've spoken to about it. me: "behold, my field of f*cks, you can see that it is barren!"
...
- [I made a one-minute video about 'jaywalking' in Denver](https://www.tiktok.com/@josh_exists/video/7340738928888040750), and then I made a [4 minute video about the same topic](https://www.tiktok.com/@josh_exists/video/7340755888300428590)
